                ...
                <div className='flex justify-between'>
                    ...
                    <div className='text-right'>
                        <ul>
                            ...
                            <li>NGÀY KHỞI TẠO: <strong>{order?.createdAt?.toString()}</strong></li>
                ...
                <div className='grid grid-cols-3 gap-10'>
                    ...
                    <div>
                        ...
                        <ul className='text-sm'>
                            ...
                            <li>Giá trị bưu kiện: {note?.productValue}</li>
                        </ul>
                    </div>
                    {order?.supplierId && (
                    <div>
                        <p className='text-xl font-bold'>Thông tin người vận chuyển</p>
                        <ul className='text-sm'>
                            <li>Mã người vận chuyển: {order?.supplierId}</li>
                            <li>Tên người vận chuyển: {order?.supplierName}</li>
                            <li>Ghi chú: {order?.supplierNote ? order?.supplierNote : '' }</li>
                        </ul>
                    </div>
                    )}
                </div>
                <div className='border-y-4 border-[#333] py-2 space-y-1'>
                    ...
                    <div className='flex justify-end right-0'>
                        <div className='flex flex-col  w-[300px]'>
                            <span>Phí vận chuyển: {order?.fee}</span>
