...
const Truck = () => {
    const services = [
        ['1', 'Xe Ba Gác', 'Trọng lượng dưới 400kg', 'Dưới 4km: 165.000vnđ'],
        ['2', 'Xe Bán Tải', 'Trọng lượng dưới 500kg', 'Dưới 4km: 165.000vnđ'],
        ['3', 'Xe Van 500KG', 'Trọng lượng dưới 500kg', 'Dưới 4km: 185.000vnđ'],
        ['4', 'Xe Tải 500KG', 'Trọng lượng dưới 500kg', 'Dưới 4km: 185.000vnđ'],
    ]
    return (
        <>
            <div className="relative bg-[url('../assets/images/customer/truck-heroimg.png')] h-screen bg-cover bg-no-repeat overflow-hidden">
                <div className='bg-blue-100 w-2/5  min-h-screen absolute rounded-tr-[100px]'>
                    <div className='ml-10 mt-40'>
                        <h1 className='font-bold'>
                            Dịch vụ xe tải
                        </h1>
                        <div className='sub_title mt-3'>
                            Ứng dụng giao hàng tức thời, đáp ứng mọi nhu cầu của bạn với nền tảng công nghệ hiện đại.
                        </div>
                        <QrCode />
                    </div>
                </div>
            ...
            <div className=''>
                ...
                <div className='lg:relative bg-orange-100 min-h-screen'>
                    <div className="mx-auto flex max-w-7xl w-full py-7 text-center lg:py-12 lg:text-left">
                ...
                <div>
                    ...
                    <div><a href="https://www.ahamove.com/services/ahatruck/price/"><button className='button_primary my-3'>Xem chi tiết các dịch vụ</button></a></div>
                </div>
                <div className='mt-8'>
                        ...
                        {services?.map((service, index) => (
                            <div key={index}>
                                <div className='border rounded-2xl px-3 py-7 min-h-[320px]'>
                                    <div className='flex justify-center'><Image src={require(`../../assets/images/service/truck/${service[0]}.png`)} alt='icon_delivery' /></div>
...
Truck.getLayout = function getLayout(page: any) {
    return (
