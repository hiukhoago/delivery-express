...
const Mart = () => {
    return (
        <>
            ...
            <div className='p-6 relative pt-16 bg-white '>
            ...
            <div className=' max-w-md px-5 mx-auto sm:max-w-3xl lg:max-w-6xl md:px-0 bg-blue-100 rounded-[30px] '>
                <div className='mt-16 mb-16 flex grid-cols-2 flex-row-reverse rounded-lg pt-0 pb-0 gap-10'>
                    <div className='mt-10 mb-10 ml-10 mr-10 flex pl-0 pr-0 text-left max-w-2xl'>
                        <div className='py-5'>
                            <h4 className='font-bold leading-16'>
                                Hợp tác kinh doanh c&ugrave;ng Ahamove
                            </h4>
                            <div className='text-lg leading-7 text-black my-5 font-medium'>
                                Đăng k&yacute; bán h&agrave;ng tr&ecirc;n ứng dụng Ahamove, dễ d&agrave;ng tiếp cận h&agrave;ng triệu khách h&agrave;ng tiềm năng v&agrave; phát triển công việc kinh doanh của bạn.
                            </div>
                            <div className="my-3">
                                <a href="https://ahamove.com/chuong-trinh-thuong-cho-tai-xe-ahamove/" target="_blank" rel="noopener noreferrer">
                    ...
                    <Image alt="" src={require('../../assets/images/service/mart/1.png')}  width={900} height={800} className='lg:h-full lg:w-full rounded-xl lg:rounded-none mx-auto' />
                </div>
            </div>
...
Mart.getLayout = function getLayout(page: any) {
    return (
